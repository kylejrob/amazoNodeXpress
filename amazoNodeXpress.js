...
// Connecting to the amazoNodeXpress Database
...
var beginApp = function(){
    connection.query("SELECT * FROM Products", function(err, result) {
        if (err) throw err;
        return (getamazoNodeXpressProducts(result));
      
      });
}

    // Function to display all of the products available for sale in a table
    var getamazoNodeXpressProducts = function (products){
        console.log("Welcome to amazoNodeXpress, here are the products we offer, the cost and stock.");
